...
Scenario: footer link header
  ...
  Then I should see " email help@dealdey.com" in footer

Scenario: social link in footer
  Then I should see social links to follow:
  |social_links|
...
Scenario: other links in footer
  ...
  |other_links|
  |about_us contact_us faq how_it_works terms_of_use privacy_policy dealdeyholic_blog conditions_policy register_as_a_merchant|
...
Scenario: dealdeyholic blog page
  And I click "Dealdeyholic Blog" in footer 
